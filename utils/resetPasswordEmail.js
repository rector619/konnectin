                ...
                >
                  <tr>
                    <td class="pad" style="padding-bottom: 10px">
                      ...
                      >
                        <p style="margin: 0">
                          Use this code to reset the password to your Konectin
                ...
                >
                  <tr>
                    <td class="pad" style="padding-bottom: 10px">
                      ...
                      >
                        <p style="margin: 0">
                          If you did not request this email, kindly ignore it or
                          reach out to support if you think your account is at
                          risk.
                        </p>
                      </div>
                    </td>
                ...
                >
                  <tr>
                    <td class="pad" style="padding-bottom: 10px">
                      ...
                      >
                        <p style="margin: 0">
                          Regards,<br /><strong>Konectin Team</strong>
                        </p>
                      </div>
                    </td>
                  </tr>
